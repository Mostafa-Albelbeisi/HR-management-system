...
function AllEmploye(EmployeeName, Department, EmployeeSalary){
    ...
    AllEmploye.prototype.printEmployee = function(){
        ...
        document.write(`<p>Employee name: ${this.EmployeeName} :<br> Department: ${this.Department} :<br> Salary ${this.salary}JD</p>`);
    }
...
const employee0 = new AllEmploye("Ghazi Samer", "Administration", salary(1500,2000));
const employee1 = new AllEmploye("Lana Ali", "Finance", salary(1500,2000));
const employee2 = new AllEmploye("Tamara Ayoub", "Administration", salary(1500,2000));
const employee3 = new AllEmploye("Safi Walid", "Development", salary(1000,1500));
const employee4 = new AllEmploye("Rana Saleh", "Development	", salary(500,1000));
